  ...
  return (
    <>
      <style>{`
        ...
        .hero-card { display: flex; align-items: center; gap: 2rem; flex-wrap: wrap; margin-bottom: 1rem; }
        .chips-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0.7rem; flex: 1; min-width: 260px; }
        .bottom-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; }
        
        @media (max-width: 768px) {
          .hero-card { flex-direction: column; align-items: stretch; gap: 1.5rem; }
          .divider-line { display: none !important; }
          .chips-grid { grid-template-columns: 1fr; min-width: 100%; }
      ...
      <Card style={{ marginBottom: "1rem", padding: "1.5rem" }} >
        <div className="hero-card">
          ...
          <div className="divider-line" style={{ width: 1, height: 70, background: "var(--border)", flexShrink: 0, alignSelf: "center" }} />
