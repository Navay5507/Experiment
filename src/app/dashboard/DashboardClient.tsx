    ...
    <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 380px), 1fr))', gap: '1.25rem', marginTop: '1.5rem' }}>
         ...
         <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column' }}>
            <div className={styles.sectionTitle} style={{ color: 'var(--text-heading)', fontSize: '1.1rem' }}>Account Insights</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', marginTop: '1.5rem', flex: 1 }}>
               <div>
                  ...
                  <div style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--text-heading)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                     <div style={{ width: 10, height: 10, borderRadius: '50%', background: metrics.cyclesCompleted > 0 ? '#ffbd2e' : 'var(--border)', boxShadow: metrics.cyclesCompleted > 0 ? '0 0 20px #ffbd2e' : 'none' }} />
               ...
               <div>
                  ...
                  <div style={{ fontSize: '1.5rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.75rem', color: 'var(--text-heading)' }}>
