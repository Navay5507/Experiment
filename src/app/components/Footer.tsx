...
export default function Footer() {
  return (
    <footer style={{ borderTop: "1px solid var(--border)", padding: "3rem 0 1.5rem", background: "var(--footer-bg)", position: "relative", zIndex: 10, overflow: "hidden", width: "100%" }}>
      <div className={styles.container} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "2rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem" }}>
          ...
          <p style={{ color: "var(--text-muted)", fontSize: "0.85rem", opacity: 0.7, textAlign: "center", margin: "0.25rem 0" }}>Instagram DM Automation, Simplified.</p>
          <a href="https://www.instagram.com/autodrop.in/" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "0.4rem", color: "var(--text-muted)", textDecoration: "none", fontSize: "0.85rem", transition: "color 0.2s" }} className="hover-theme-heading">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
            <span style={{ fontWeight: 600 }}>@autodrop.in</span>
          </a>
        </div>
