    ...
    <main className={styles.container}>
      <header className={styles.header}>
        <Link href="/" style={{ textDecoration: 'none' }}>
          <div className={styles.logo}>Autodrop <span style={{ color: '#a855f7' }}>Support</span></div>
        </Link>
        <button onClick={() => router.back()} className={styles.backBtn} style={{ cursor: 'pointer', background: 'transparent', border: '1px solid rgba(255,255,255,0.1)' }}>
           ← Go Back
        </button>
      </header>
