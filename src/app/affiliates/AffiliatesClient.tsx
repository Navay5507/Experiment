...
import { ArrowRight, CheckCircle2, DollarSign, RefreshCcw, ShieldCheck, TrendingUp, Zap } from "lucide-react";
         ...
         <div className={styles.container} style={{ maxWidth: '800px' }}>
            ...
            <FadeIn delay={0.2}>
               ...
               <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                  <Link href="/dashboard/referral" className="premium-btn" style={{ padding: '1.25rem 3rem', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <section style={{ padding: '8rem 0', textAlign: 'center', background: 'radial-gradient(circle at center, rgba(59, 130, 246, 0.1) 0%, transparent 60%)' }}>
        <div className={styles.container}>
          <FadeIn>
             ...
             <Link href="/dashboard/referral" className="premium-btn" style={{ padding: '1.25rem 3rem', fontSize: '1.2rem' }}>Become a Partner</Link>
          </FadeIn>
        </div>
      </section>
